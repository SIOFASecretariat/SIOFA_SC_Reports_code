...
# catch and effort 
LL= read_excel( "Data/SIOFA_3b_Toothfish_catch_effort-2024-rev1.xlsx")

# tagging 
Rel= read_excel( "Data/SIOFA_3b_tagging-2024.xlsx",sheet ='tag_release_3b')
Rec= read_excel( "Data/SIOFA_3b_tagging-2024.xlsx",sheet ='tag_recapture_3b')
Rlink= read_excel( "Data/SIOFA_3b_tagging-2024.xlsx",sheet ='tag_linking')

# link tag fished and set
LinkOP_release= read_excel( "Data/SIOFA_3b_tag_operation_link-2024.xlsx",sheet ='tag_release')
LinkOP_recapture= read_excel( "Data/SIOFA_3b_tag_operation_link-2024.xlsx",sheet ='tag_recapture')

# biological sampling
Bio= read_excel( "Data/SIOFA_3b_fish_sampling-2024.xlsx")
