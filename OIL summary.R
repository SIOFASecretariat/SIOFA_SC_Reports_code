...
# plot plot world map and add SIOFA subareas + 5 degree resolution SIOFA OIL fishing events on world map
...
# plot plot world map and add SIOFA subareas + 1 degree resolution siofa OIL fishing events on world map
...
# plot plot world map and add SIOFA subareas + 20' resolution siofa OIL fishing events on world map
...
ggplot(data= subset(yearly_nontarget_catches_oilfish), aes(x = Year, y = x)) +
  ...
  labs(title="Yearly non-target catch by species in OIL/LEC fisheries in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
...
ggplot(catch_bycatch_OIL, aes(x = Year, y = t, fill=Catch)) +
  ...
  labs(title="Yearly catch/bycatch in OIL/LEC fisheries in the SIOFA area (absolute)", x="Year", y="Total catch (t)") +
  theme_bw() +
  scale_x_continuous(limits=c(2016, 2023)) +
...
ggplot(catch_bycatch_OIL, aes(x = Year, y = t, fill=Catch)) +
  ...
  labs(title="Yearly catch/bycatch in OIL fisheries in the SIOFA area (relative)", x="Year", y="Total catch (%)") +
  theme_bw() +
...
ggplot(catch_bycatch_subarea_OIL, aes(x = Year, y = t)) +
  ...
  labs(title="Yearly bycatch in OIL/LEC fisheries by SIOFA subareas (absolute)", x="Year", y="Non-target catch (t)") +
  scale_fill_manual(values=c("#8dd3c7", "#ffffb3", "#fb8072")) +
  #scale_fill_brewer(type = "seq", palette = "Set3") +
  theme_bw() +
  scale_x_continuous(limits=c(2016, 2023)) +
...
catch_bycatch_subarea_OIL_table_subarea <- catch_bycatch_subarea_OIL %>%
  ...
  rename('Target catch (t)' = TargetCatch,
         'Non-target catch (t)' = NonTargetCatch)
...
ggplot(data= subset(yearly_nontarget_catches_oilfish, Species %in% OIL5_species$Species), aes(x = Year, y = NonTargetCatch)) +
  ...
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  labs(title="Yearly bycatch by species in OIL/LEC fisheries in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
...
ggplot(data= subset(yearly_sharks_catches_OIL, Species %in% OIL5_shark_species$Species), aes(x = Year, y = NonTargetCatch)) +
  ...
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  labs(title="Yearly bycatch of sharks in OIL/LEC fisheries in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
...
ggplot(catch_bycatch_subarea_OIL, aes(x = Year, y = TargetCatch)) +
  ...
  labs(title="Yearly target catch in OIL/LEC fisheries by SIOFA subareas (relative)", x="Year", y="Target catch (%)") +
  scale_fill_brewer(type = "seq", palette = "Set3") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4) 
...
ggplot(catch_bycatch_subarea_OIL, aes(x = Year, y = NonTargetCatch)) +
  geom_bar(aes(fill=SubAreaNo), position="fill", stat="identity") +
  labs(title="Yearly bycatch in OIL/LEC fisheries by SIOFA subareas (relative)", x="Year", y="Non-target catch (%)") +
  scale_fill_brewer(type = "seq", palette = "Set3") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4) 
...
ggplot(catch_bycatch_OIL, aes(x = Year, y = t, fill=Catch)) +
  geom_bar(position="fill", stat="identity") +
  labs(title="Yearly catch/bycatch in OIL/LEC fisheries in the SIOFA area (relative)", x="Year", y="Total catch (%)") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  scale_fill_hue(labels = c("Non-target Catch", "Target Catch")) +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4) 
...
ggplot(data= subset(yearly_nontarget_catches_oilfish, Species %in% OIL5_species$Species), aes(x = Year, y = NonTargetCatch)) +
  ...
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  labs(title="Yearly non-target catch by species in the fisheries targeting OIL in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
