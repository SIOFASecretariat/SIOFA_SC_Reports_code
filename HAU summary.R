...
ggplot() +
  ...
  ggtitle("SIOFA HAU fishing activities (hybrid 20'+30', 2013–2022)") +
...
ggplot() +
  ...
  coord_sf(crs = "4326") +
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("SIOFA HAU fishing activities (5 degrees, 2013–2022)") +
  coord_sf(xlim = c(25, 125), ylim = c(15, -60), expand = FALSE) +
...
# plot plot world map and add SIOFA subareas + 1 degree resolution siofa HAU fishing events on world map
...
ggplot() +
  ...
  coord_sf(crs = "4326") +
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("SIOFA HAU fishing activities (1 degree, 2013–2022)") +
  coord_sf(xlim = c(25, 125), ylim = c(15, -60), expand = FALSE) +
  labs(fill="N. fishing events") +
  annotation_scale(location = "bl", width_hint = 0.1) +
  annotation_north_arrow(location = "tl", which_north = "true", 
...
ggplot() +
  ...
  coord_sf(crs = "4326") +
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("SIOFA HAU fishing activities (30', 2013–2022)") +
  coord_sf(xlim = c(25, 125), ylim = c(15, -60), expand = FALSE) +
  labs(fill="N. fishing events") +
  annotation_scale(location = "bl", width_hint = 0.1) +
  annotation_north_arrow(location = "tl", which_north = "true", 
...
ggplot() +
  ...
  coord_sf(crs = "4326") +
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("SIOFA HAU fishing activities (20', 2013–2022)") +
  coord_sf(xlim = c(25, 125), ylim = c(15, -60), expand = FALSE) +
  labs(fill="N. fishing events") +
  annotation_scale(location = "bl", width_hint = 0.1) +
  annotation_north_arrow(location = "tl", which_north = "true", 
...
ggplot(data= subset(yearly_nontarget_catches_hapuka, Species %in% HAU5_species$Species), aes(x = Year, y = NonTargetCatch)) +
  ...
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  labs(title="Yearly bycatch by species in HAU fisheries in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
...
ggplot(data= subset(yearly_sharks_catches_HAU, Species %in% HAU5_shark_species$Species), aes(x = Year, y = NonTargetCatch)) +
  ...
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  labs(title="Yearly bycatch of sharks in HAU fisheries in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
...
ggplot(catch_bycatch_subarea_HAU, aes(x = Year, y = TargetCatch)) +
  ...
  labs(title="Yearly target catch in HAU fisheries by SIOFA subareas (relative)", x="Year", y="Target catch (%)") +
  scale_fill_brewer(type = "seq", palette = "Set3") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4) 
...
ggplot(catch_bycatch_subarea_HAU, aes(x = Year, y = NonTargetCatch)) +
  geom_bar(aes(fill=SubAreaNo), position="fill", stat="identity") +
  labs(title="Yearly bycatch in HAU fisheries by SIOFA subareas (relative)", x="Year", y="Non-target catch (%)") +
  scale_fill_brewer(type = "seq", palette = "Set3") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4) 
...
ggplot(catch_bycatch_HAU, aes(x = Year, y = t, fill=Catch)) +
  ...
  labs(title="Yearly catch/bycatch in HAU fisheries in the SIOFA area (absolute)", x="Year", y="Total catch (t)") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
...
ggplot(catch_bycatch_HAU, aes(x = Year, y = t, fill=Catch)) +
  ...
  labs(title="Yearly catch/bycatch in HAU fisheries in the SIOFA area (relative)", x="Year", y="Total catch (%)") +
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  scale_fill_hue(labels = c("Non-target Catch", "Target Catch")) +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4) 
...
ggplot(data= subset(bycatch_HAU_species, Species %in% HAU5_species$Species), aes(x = Year, y = NonTargetCatch)) +
  ...
  theme_bw() +
  scale_x_continuous(limits=c(2012, 2023)) +
  labs(title="Yearly non-target catch by species in the fisheries targeting HAU in the SIOFA area", x="Year", y="Non-target catch (t)") +
  theme(plot.title = element_text(hjust = 0.5), aspect.ratio=0.4)
...
ggplot() +
  ...
  ggtitle("SIOFA incidental captures of seabirds, marine mammals, turtles and 
          sharks considered to be at high risk and/or of concern in HAU target operations (2012-2022)") +
  coord_sf(xlim = c(25, 125), ylim = c(15, -60), expand = FALSE) +
...
ggplot() +
  ...
  ggtitle("SIOFA observations of seabirds and marine mammals
            in HAU target operations (2012-2022)") +
  coord_sf(xlim = c(25, 125), ylim = c(15, -60), expand = FALSE) +
